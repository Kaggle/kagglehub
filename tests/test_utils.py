...
def function_to_test(success_on_attempt):
...
class TestRetryDecorator(unittest.TestCase):
    ...
    def test_retry_success_before_limit(self, mock_logger_info, mock_sleep):
    ...
    @patch('integration_tests.test_model_upload.time.sleep', autospec=True)
    @patch('integration_tests.test_model_upload.logger.info', autospec=True)
    def test_retry_reaches_limit_raises_timeout(self, mock_logger_info, mock_sleep):
